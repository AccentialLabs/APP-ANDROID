...
public class BuyErrorActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.activity_buy_error);	
		...
		txtVoltar = (TextView) findViewById(R.id.textView2);
		...
		txtVoltar.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {

				intentSend = new Intent(BuyErrorActivity.this, CheckActivity.class);
